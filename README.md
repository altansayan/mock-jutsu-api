...
[![Tests](https://img.shields.io/badge/tests-4251%20passed-22c55e?style=for-the-badge&logo=pytest)](./tests)
...
[**Installation**](#%EF%B8%8F-installation) • [**Why Mock Jutsu?**](#-why-not-faker) • [**Usage Guide**](#-usage) • [**251 Types**](#236-supported-data-types)
...
- **4251 Automated Tests**: We don't guess. We verify. Every single format and locale is rigorously tested against real-world algorithmic specifications.
...
*(See our interactive guides for the full list of 251 types:
