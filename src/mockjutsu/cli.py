...
def _print_banner() -> None:
    ...
    body.append("\n")
    body.append("MockJutsu API & Postman Collection\n",       style="dim white")
    body.append("https://github.com/altansayan/mock-jutsu-api\n", style="dim blue")
    body.append("\n")
    body.append("MockJutsu Docker Hub\n",                    style="dim white")
    body.append("https://hub.docker.com/r/altansezerayan/mock-jutsu\n", style="dim blue")
    body.append("\n")
    body.append("MockJutsu JMeter Plugin\n",                 style="dim white")
    body.append("https://github.com/altansayan/mock-jutsu-jmeter\n", style="dim blue")
    body.append("\n")
    body.append("Licensed under the MIT License\n", style="dim white")
    body.append("Copyright (c) 2026 Altan Sezer Ayan - A.S.A", style="dim white")
...
_REFERENCE = [
    ...
    ('balance'        , 'Financial'    , False, '12450.75'              , 'generate balance'              , 'Random account balance with 2 decimal precision.', '--min (float), --max (float)'),
...
@click.option('--pattern',   default=None,     help='Regex pattern for reverse_regex type (e.g. "[A-Z]{3}\\d{4}")')
